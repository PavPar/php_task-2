                                    ...
                                    <td width="492" valign="top" height="106">
                                        ...
                                        <div style="margin-left:1px; margin-top:2px; margin-right:10px "><br>
                                            ...
                                            <div style="margin-left:95px ">
                                                <php> </php>
                                                <form class="form-auth" action="pages/auth.php" method="POST" enctype="multipart/form-data">
                                                    <label class="form-auth__label" for="login" >Логин :</label>
                                                    <input class="form-auth__input" id="login" required type="text" name="login">
                                                    <label class="form-auth__label" for="password">Пароль :</label>
                                                    <input class="form-auth__input" id="password" required
                                                        type="password" name="password">
                                                    <input class="form-auth__button" type="submit" value="Войти">
                                                </form>
                                            </div>
                                        </div>
                                    </td>
